...
// Define the comprehensive translation map for all 21 products in 9 languages
const allProductsTranslations: Record<string, Record<string, {
  title: string;
  subtitle: string;
  description: string;
...
// Write out products data json
fs.writeFileSync(path.join(process.cwd(), 'src/i18n/catalogData/productsPartial.json'), JSON.stringify(allProductsTranslations, null, 2), 'utf-8');
console.log('Saved productsPartial.json');
