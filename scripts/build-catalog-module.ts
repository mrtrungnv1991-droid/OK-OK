...
// Let's create a script that builds the complete catalogTranslations.ts
const scriptContent = `import { Product, GroupPool, GameItem, CategoryItem } from '../types';
...
// 21 Products x 9 Locales Translations Map
export const PRODUCT_TRANSLATIONS: Record<string, Record<string, LocalizedProductText>> = {
  'prod-chatgpt-plus': {
    'vi': {
