import { LocalizedProductData } from '../catalogTranslations';

export const ALL_PRODUCTS_DATA: Record<string, Record<string, LocalizedProductData>> = {
  "prod-chatgpt-plus": {
    "vi": {
  ...
  "prod-cyberpunk-phantom-liberty": {
    "vi": {
      ...
      "features": [
        "Bao gồm game gốc + DLC Phantom Liberty",
        "Kích hoạt tài khoản Steam chính chủ (Global)",
        "Đồ hoạ Path Tracing đỉnh cao công nghệ",
        "Bảo hành vĩnh viễn"
      ],
      "instructions": [
        "1. Nhận mã Steam CDKey trong Vault",
        "2. Mở Steam -> Add a Game -> Activate a Product on Steam",
        "3. Tải game và khám phá Night City"
      ],
      "tags": [
        "Steam",
        "Cyberpunk",
    ...
    "en": {
      ...
      "features": [
        ...
        "Activates directly on personal Steam account (Global)",
        "Cutting-edge Path Tracing graphical fidelity",
        "Lifetime warranty guarantee"
      ],
      "instructions": [
        "1. Retrieve your Steam CDKey from Vault",
        "2. Open Steam -> Games -> Activate a Product on Steam",
        "3. Download and explore Night City"
      ],
      "tags": [
        "Steam",
        "Cyberpunk",
    ...
    "zh": {
      ...
      "features": [
        "包含完整游戏本体及《往日之影》大型扩展包",
        "直接激活至个人 Steam 主账号（全球无锁区）",
        "支持全景光线追踪 Path Tracing 顶级视效",
        "终身质保保障，永不召回"
      ],
      "instructions": [
        "1. 在保险库中复制您的 Steam CDKey",
        "2. 打开 Steam 客户端 -> 游戏 -> 在 Steam 上激活产品",
        "3. 下载游戏尽情踏入夜之城冒险"
      ],
      "tags": [
        "Steam",
    ...
    "ja": {
      ...
      "features": [
        "本編 ＋ 拡張パック「仮初めの自由」完全収録",
        "個人の Steam アカウントに直接登録可能（地域制限なし）",
        "超美麗なパストレーシング技術に対応",
        "永久保証付き"
      ],
      "instructions": [
        "1. Vault から Steam CDKey を取得",
        "2. Steam 起動 -> ゲーム -> Steam でアイテムを有効化",
        "3. ゲームをインストールしてナイトシティへ"
      ],
      "tags": [
        "Steam",
        "サイバーパンク",
    ...
    "ko": {
      ...
      "features": [
        "본편 게임 및 팬텀 리버티 확장팩 전체 포함",
        "개인 Steam 본계정 직접 활성화 (국가 제한 없음)",
        "초고화질 패스 트레이싱 그래픽 기술 지원",
        "영구 소장 정품 보증"
      ],
      "instructions": [
        "1. 볼트에서 Steam CDKey 복사",
        "2. Steam 실행 -> 게임 -> Steam에 제품 등록",
        "3. 다운로드 후 나이트 시티 모험 시작"
      ],
      "tags": [
        "Steam",
        "사이버펑크",
    ...
    "ru": {
      ...
      "features": [
        "Игра + дополнение Phantom Liberty",
        "Активация на личный аккаунт Steam (Global)",
        "Графика Path Tracing нового поколения",
        "Пожизненная гарантия"
      ],
      "instructions": [
        "1. Скопируйте ключ из Vault",
        "2. Steam -> Игры -> Активировать в Steam",
        "3. Скачайте игру и начните приключение"
      ],
      "tags": [
        "Steam",
        "Cyberpunk",
    ...
    "fr": {
      ...
      "features": [
        "Jeu de base + extension Phantom Liberty",
        "Activation directe sur compte Steam personnel",
        "Technologie graphique avancée Path Tracing",
        "Garantie à vie"
      ],
      "instructions": [
        "1. Récupérez votre clé Steam dans le Vault",
        "2. Ouvrez Steam -> Jeux -> Activer un produit sur Steam",
        "3. Téléchargez le jeu et explorez Night City"
      ],
      "tags": [
        "Steam",
        "Cyberpunk",
    ...
    "de": {
      ...
      "features": [
        "Hauptspiel + Phantom Liberty Erweiterung",
        "Direkt auf eigenem Steam-Konto aktivierbar (Global)",
        "Next-Gen Raytracing Overdrive Technologie",
        "Lebenslange Garantie"
      ],
      "instructions": [
        "1. Steam-Key im Vault abrufen",
        "2. Steam öffnen -> Spiele -> Produkt bei Steam aktivieren",
        "3. Spiel herunterladen und Night City erkunden"
      ],
      "tags": [
        "Steam",
        "Cyberpunk",
    ...
    "es": {
      ...
      "features": [
        "Incluye juego base + expansión Phantom Liberty",
        "Activación directa en tu cuenta de Steam (Global)",
        "Gráficos avanzados con trazado de rayos",
        "Garantía de por vida"
      ],
      "instructions": [
        "1. Obtén tu CDKey de Steam en tu Vault",
        "2. Abre Steam -> Juegos -> Activar un producto en Steam",
        "3. Descarga el juego y explora Night City"
      ],
      "tags": [
        "Steam",
        "Cyberpunk",
  ...
  "prod-elden-ring-erdtree": {
    "vi": {
      ...
      "features": [
        "Bao gồm Elden Ring + DLC Shadow of the Erdtree",
        "Kích hoạt tài khoản Steam chính chủ (Global)",
        "Game of the Year danh giá từ FromSoftware",
        "Bảo hành vĩnh viễn"
      ],
      "instructions": [
        "1. Nhận mã Steam CDKey trong Vault",
        "2. Mở Steam -> Add a Game -> Activate a Product on Steam",
        "3. Tải game và chinh phục Vùng đất Bóng tối"
      ],
      "tags": [
        "Steam",
        "Elden Ring",
    ...
    "en": {
      ...
      "features": [
        "Includes Elden Ring + Shadow of the Erdtree DLC",
        "Activates directly on personal Steam account (Global)",
        "Legendary Game of the Year from FromSoftware",
        "Lifetime warranty guarantee"
      ],
      "instructions": [
        "1. Retrieve your Steam CDKey from Vault",
        "2. Open Steam -> Games -> Activate a Product on Steam",
        "3. Download and conquer the Land of Shadow"
      ],
      "tags": [
        "Steam",
        "Elden Ring",
    ...
    "ja": {
      ...
      "features": [
        "ELDEN RING 本編 ＋ 拡張DLC を完全同梱",
        "個人の Steam アカウントに直接登録可能（国制限なし）",
        "FromSoftware による究極のアクションRPG",
        "永久保証付き"
      ],
      "instructions": [
        "1. Vault から Steam CDKey を取得",
    ...
    "ko": {
      ...
      "features": [
        "엘든 링 본편 + 황금 나무의 그림자 DLC 포함",
        "개인 Steam 본계정 직접 활성화 (글로벌 무제한)",
        "전 세계 수많은 올해의 게임(GOTY) 수상작",
        "영구 소장 정품 보증"
      ],
      "instructions": [
        "1. 볼트에서 Steam CDKey 복사",
        "2. Steam 실행 -> 게임 -> Steam에 제품 등록",
        "3. 그림자의 땅으로 떠나는 빛바랜 자의 여정"
      ],
      "tags": [
        "Steam",
        "엘든링",
    ...
    "ru": {
      ...
      "features": [
        "Игра + дополнение Shadow of the Erdtree",
        "Активация на личный аккаунт Steam (Global)",
        "Игра года от студии FromSoftware",
        "Пожизненная гарантия"
      ],
      "instructions": [
        "1. Скопируйте ключ из Vault",
        "2. Steam -> Игры -> Активировать в Steam",
        "3. Отправляйтесь в Земли Теней"
      ],
      "tags": [
        "Steam",
        "Elden Ring",
    ...
    "fr": {
      ...
      "features": [
        "Comprend Elden Ring + DLC Shadow of the Erdtree",
        "Activation directe sur compte Steam personnel",
        "Jeu de l’Année légendaire de FromSoftware",
        "Garantie à vie"
      ],
      "instructions": [
        "1. Récupérez votre clé Steam dans le Vault",
        "2. Ouvrez Steam -> Jeux -> Activer un produit sur Steam",
        "3. Téléchargez et partez à la conquête des ombres"
      ],
      "tags": [
        "Steam",
        "Elden Ring",
    ...
    "de": {
      ...
      "features": [
        "Enthält Elden Ring + Shadow of the Erdtree DLC",
        "Direkt auf eigenem Steam-Konto aktivierbar (Global)",
        "Ausgezeichnetes Spiel des Jahres von FromSoftware",
        "Lebenslange Garantie"
      ],
      "instructions": [
        "1. Steam-Key im Vault abrufen",
        "2. Steam öffnen -> Spiele -> Produkt bei Steam aktivieren",
        "3. Schattenland betreten und Herausforderungen meistern"
      ],
      "tags": [
        "Steam",
        "Elden Ring",
    ...
    "es": {
      ...
      "features": [
        "Incluye Elden Ring + DLC Shadow of the Erdtree",
        "Activación directa en tu cuenta de Steam (Global)",
        "Juego del Año con combates legendarios",
        "Garantía de por vida"
      ],
      "instructions": [
        "1. Obtén tu CDKey de Steam en tu Vault",
        "2. Abre Steam -> Juegos -> Activar un producto en Steam",
        "3. Descarga y adéntrate en las Tierras de las Sombras"
      ],
      "tags": [
        "Steam",
        "Elden Ring",
  ...
  "prod-ea-fc-25": {
    "vi": {
      ...
      "features": [
        "Chiến thuật thông minh FC IQ & Chế độ 5v5 Rush",
        "Đầy đủ giải đấu UEFA, Premier League, LaLiga",
        "Chơi online Ultimate Team mượt mà",
        "Bảo hành vĩnh viễn"
      ],
      "instructions": [
        "1. Lấy mã kích hoạt trong Vault",
        "2. Kích hoạt trên EA App hoặc Steam",
        "3. Tải game và bắt đầu trận đấu đỉnh cao"
      ],
      "tags": [
        "EA Sports",
        "FC 25",
    ...
    "en": {
      ...
      "features": [
        "FC IQ tactical foundation & dynamic 5v5 Rush mode",
        "Authentic UEFA, Premier League, and LaLiga licenses",
        "Full online Ultimate Team & Clubs competition",
        "Lifetime warranty guarantee"
      ],
      "instructions": [
        "1. Retrieve activation code from Vault",
        "2. Redeem in EA App or Steam client",
        "3. Download and kick off your match"
      ],
      "tags": [
        "EA Sports",
        "FC 25",
    ...
    "zh": {
      ...
      "features": [
        "全新 FC IQ 战术系统与 5v5 Rush 快节奏模式",
        "欧冠联赛、英超、西甲等官方正版授权",
        "流畅在线 Ultimate Team 梦幻球队对战",
        "终身质保保障，永不召回"
      ],
      "instructions": [
        "1. 在保险库中获取激活码",
        "2. 在 EA App 或 Steam 客户端中兑换产品",
        "3. 下载游戏即刻开球开战"
      ],
      "tags": [
        "EA Sports",
    ...
    "ja": {
      ...
      "features": [
        "FC IQ 戦術システム＆スピーディーな 5v5 Rush",
        "UEFA チャンピオンズリーグ・プレミアリーグ公式収録",
        "Ultimate Team での快適なオンライン対戦",
        "永久保証付き"
      ],
      "instructions": [
        "1. Vault からアクティベーションコードを取得",
        "2. EA App または Steam でコードを引き換え",
        "3. ゲームをダウンロードしてキックオフ"
      ],
      "tags": [
        "EA Sports",
    ...
    "ko": {
      ...
      "features": [
        "혁신적인 FC IQ 전술 엔진 및 5v5 Rush 모드",
        "UEFA, 프리미어리그, 라리가 공식 라이선스",
        "Ultimate Team 및 클럽 모드 온라인 지원",
        "영구 소장 정품 보증"
      ],
      "instructions": [
        "1. 볼트에서 활성화 코드 복사",
        "2. EA App 또는 Steam에서 제품 등록",
        "3. 게임 설치 후 바로 킥오프"
      ],
      "tags": [
        "EA Sports",
    ...
    "ru": {
      ...
      "features": [
        "Тактическая система FC IQ и режим 5v5 Rush",
        "Официальные турниры UEFA, Premier League, LaLiga",
        "Полноценный онлайн в Ultimate Team и Клубах",
        "Пожизненная гарантия"
      ],
      "instructions": [
        "1. Получите код в Vault",
        "2. Активируйте в EA App или Steam",
        "3. Скачайте игру и начните матч"
      ],
      "tags": [
        "EA Sports",
        "FC 25",
    ...
    "fr": {
      ...
      "features": [
        "Système tactique FC IQ & mode 5v5 Rush dynamique",
        "Licences authentiques UEFA, Premier League, LaLiga",
        "Compétition en ligne Ultimate Team & Clubs",
        "Garantie à vie"
      ],
      "instructions": [
        "1. Récupérez le code dans votre Vault",
        "2. Activez sur l’application EA ou Steam",
        "3. Téléchargez le jeu et donnez le coup d’envoi"
      ],
      "tags": [
        "EA Sports",
        "FC 25",
    ...
    "de": {
      ...
      "features": [
        "FC IQ Taktiksystem & dynamischer 5v5 Rush Modus",
        "Authentische Lizenzen von UEFA, Premier League & LaLiga",
        "Vollwertiger Ultimate Team & Clubs Online-Modus",
        "Lebenslange Garantie"
      ],
      "instructions": [
        "1. Code im Cyber Vault abrufen",
        "2. In EA App oder Steam aktivieren",
        "3. Spiel herunterladen und anstoßen"
      ],
      "tags": [
        "EA Sports",
        "FC 25",
    ...
    "es": {
      ...
      "features": [
        "Sistema táctico FC IQ y modo dinámico 5v5 Rush",
        "Licencias auténticas de UEFA, Premier League y LaLiga",
        "Competencia online completa en Ultimate Team",
        "Garantía de por vida"
      ],
      "instructions": [
        "1. Obtén tu código de activación en el Vault",
        "2. Canjea en EA App o cliente de Steam",
        "3. Descarga y sal al terreno de juego"
      ],
      "tags": [
        "EA Sports",
        "FC 25",
  ...
  "prod-win11-pro-retail": {
    "vi": {
      ...
      "features": [
        "Key Retail kích hoạt trực tiếp trên server Microsoft",
        "Gắn liền phần cứng (hỗ trợ cài lại Win không mất bản quyền)",
        "Đầy đủ tính năng BitLocker, Sandbox, Hyper-V",
        "Bảo hành vĩnh viễn 1 đổi 1"
      ],
      "instructions": [
        "1. Vào Settings -> System -> Activation trên máy tính",
        "2. Chọn Change product key và dán mã key từ Vault",
        "3. Nhấn Activate để sở hữu Windows 11 Pro vĩnh viễn"
      ],
      "tags": [
        "Microsoft",
        "Windows 11 Pro",
    ...
    "en": {
      ...
      "features": [
        "Genuine Retail key activated directly with Microsoft",
        "Hardware-bound (survives system reinstalls)",
        "Full BitLocker, Windows Sandbox, and Hyper-V features",
        "Lifetime replacement warranty guarantee"
      ],
      "instructions": [
        "1. Go to Settings -> System -> Activation on your PC",
        "2. Click Change product key and paste the key from Vault",
        "3. Click Activate to unlock Windows 11 Pro forever"
      ],
      "tags": [
        "Microsoft",
        "Windows 11 Pro",
    ...
    "zh": {
      ...
      "features": [
        "官方正版 Retail 密钥直连微软激活",
        "永久数字权利绑定主板，重装不掉激活",
        "支持 BitLocker 加密、沙盒 Sandbox 与 Hyper-V",
        "终身质保保障，假一赔十"
      ],
      "instructions": [
        "1. 打开电脑 设置 -> 系统 -> 激活",
        "2. 点击“更改产品密钥”并粘贴保险库中的密钥",
        "3. 点击“激活”即可永久升级至 Windows 11 Pro"
      ],
      "tags": [
        "微软",
        "Windows 11 Pro",
    ...
    "ja": {
      ...
      "features": [
        "Microsoft 公式サーバーで直接オンライン認証",
        "マザーボード紐づけ（OS再インストール対応）",
        "BitLocker、Sandbox、Hyper-V 完全対応",
        "永久ライセンス保証付き"
      ],
      "instructions": [
        "1. 設定 -> システム -> ライセンス認証を開く",
        "2.「プロダクトキーの変更」をクリックしキーを貼り付け",
        "3.「有効化」をクリックして完了"
      ],
      "tags": [
        "Microsoft",
    ...
    "ko": {
      ...
      "features": [
        "MS 공식 정품 리테일 온라인 즉시 인증",
        "메인보드 영구 귀속 (재설치 및 포맷 지원)",
        "BitLocker 암호화, 샌드박스, Hyper-V 전체 지원",
        "평생 정품 1:1 교환 보증"
      ],
      "instructions": [
        "1. PC 설정 -> 시스템 -> 정품 인증 메뉴 이동",
        "2. 제품 키 변경 클릭 후 볼트의 키 입력",
        "3. 정품 인증 클릭으로 영구 활성화 완료"
      ],
      "tags": [
        "Microsoft",
        "Windows 11 Pro",
    ...
    "ru": {
      ...
      "features": [
        "Retail ключ с онлайн-активацией в Microsoft",
        "Привязка к железу (сохраняется при переустановке)",
        "Полный функционал BitLocker, Sandbox и Hyper-V",
        "Пожизненная гарантия"
      ],
      "instructions": [
        "1. Параметры -> Система -> Активация",
        "2. Нажмите «Изменить ключ» и вставьте ключ из Vault",
        "3. Нажмите «Активировать» для бессрочной лицензии"
      ],
      "tags": [
        "Microsoft",
        "Windows 11 Pro",
    ...
    "fr": {
      ...
      "features": [
        "Clé Retail authentique activée chez Microsoft",
        "Liée au matériel (persiste après réinstallation)",
        "Fonctionnalités complètes BitLocker, Sandbox, Hyper-V",
        "Garantie à vie"
      ],
      "instructions": [
        "1. Rendez-vous dans Paramètres -> Système -> Activation",
        "2. Cliquez sur Modifier la clé et collez la clé du Vault",
        "3. Cliquez sur Activer pour débloquer Windows 11 Pro"
      ],
      "tags": [
        "Microsoft",
        "Windows 11 Pro",
    ...
    "de": {
      ...
      "features": [
        "Originaler Retail-Schlüssel mit direkter Online-Aktivierung",
        "Hardwaregebunden (übersteht Neuinstallationen)",
        "Vollversion mit BitLocker, Sandbox & Hyper-V",
        "Lebenslange Umtauschgarantie"
      ],
      "instructions": [
        "1. Auf dem PC Einstellungen -> System -> Aktivierung öffnen",
        "2. Produktschlüssel ändern wählen und Key aus dem Vault einfügen",
    ...
    "es": {
      ...
      "features": [
        "Clave Retail genuina con activación directa en Microsoft",
        "Vinculada al hardware (se mantiene tras formatear)",
        "Acceso completo a BitLocker, Sandbox y Hyper-V",
        "Garantía de por vida"
      ],
      "instructions": [
        "1. Ve a Configuración -> Sistema -> Activación en tu PC",
        "2. Selecciona Cambiar clave de producto y pega la clave",
        "3. Haz clic en Activar para disfrutar de Windows 11 Pro"
      ],
      "tags": [
        "Microsoft",
        "Windows 11 Pro",
  ...
  "prod-office-2024-pro": {
    "vi": {
      ...
      "features": [
        "Gồm Word, Excel, PowerPoint, Outlook, Access 2024",
        "Kích hoạt vĩnh viễn không đóng phí hàng năm",
        "Tương thích Windows 10 và Windows 11",
        "Bảo hành trọn đời"
      ],
      "instructions": [
        "1. Tải bộ cài đặt Office 2024 chính hãng từ Microsoft",
        "2. Mở ứng dụng Word và nhập mã key bản quyền",
        "3. Kích hoạt online thành công"
      ],
      "tags": [
        "Microsoft",
        "Office 2024",
    ...
    "en": {
      ...
      "features": [
        "Includes Word, Excel, PowerPoint, Outlook, Access 2024",
        "Permanent lifetime activation with zero annual fees",
        "Fully compatible with Windows 10 and Windows 11",
        "Lifetime replacement warranty guarantee"
      ],
      "instructions": [
        "1. Download official Office 2024 installer from Microsoft",
        "2. Open Word and enter your genuine product key",
        "3. Complete online activation instantly"
      ],
      "tags": [
        "Microsoft",
        "Office 2024",
    ...
    "zh": {
      ...
      "features": [
        "包含 Word、Excel、PowerPoint、Outlook、Access 2024",
        "终身永久授权买断制，无后续订阅费用",
        "完美兼容 Windows 10 与 Windows 11 操作系统",
        "终身质保保障，官方正品保证"
      ],
      "instructions": [
        "1. 从微软官方通道下载 Office 2024 官方安装包",
        "2. 安装后打开 Word 输入保险库中的正版密钥",
        "3. 联网一键完成正版激活"
      ],
      "tags": [
        "微软",
    ...
    "ja": {
      ...
      "features": [
        "Word、Excel、PowerPoint、Outlook、Access 2024 収録",
        "月額・年額料金不要の完全買い切り永久版",
        "Windows 10 および Windows 11 に完全対応",
        "永久ライセンス保証付き"
      ],
      "instructions": [
        "1. Microsoft 公式より Office 2024 をダウンロード",
        "2. Word を起動しプロダクトキーを入力",
        "3. オンライン認証を完了して利用開始"
      ],
      "tags": [
        "Microsoft",
    ...
    "ko": {
      ...
      "features": [
        "Word, Excel, PowerPoint, Outlook, Access 2024 전체",
        "구독료 없는 1회 구매 영구 정품 라이선스",
        "Windows 10 및 Windows 11 완벽 지원",
        "평생 정품 무상 AS 보증"
      ],
      "instructions": [
        "1. MS 공식 사이트에서 Office 2024 설치 파일 다운로드",
        "2. Word 실행 후 볼트에서 확인한 정품 키 입력",
        "3. 온라인 즉시 인증 완료"
      ],
      "tags": [
        "Microsoft",
    ...
    "ru": {
      ...
      "features": [
        "Word, Excel, PowerPoint, Outlook, Access 2024",
        "Бессрочная лицензия без ежегодных платежей",
        "Совместимость с Windows 10 и Windows 11",
        "Пожизненная гарантия"
      ],
      "instructions": [
        "1. Скачайте официальный дистрибутив Office 2024",
        "2. Откройте Word и введите лицензионный ключ",
        "3. Активируйте онлайн за 1 минуту"
      ],
      "tags": [
        "Microsoft",
        "Office 2024",
    ...
    "fr": {
      ...
      "features": [
        "Comprend Word, Excel, PowerPoint, Outlook, Access 2024",
        "Licence permanente sans frais annuels",
        "Compatible Windows 10 et Windows 11",
        "Garantie à vie"
      ],
      "instructions": [
        "1. Téléchargez l’installateur officiel d’Office 2024",
        "2. Ouvrez Word et entrez votre clé de produit",
        "3. Finalisez l’activation en ligne"
      ],
      "tags": [
        "Microsoft",
        "Office 2024",
    ...
    "de": {
      ...
      "features": [
        "Enthält Word, Excel, PowerPoint, Outlook, Access 2024",
        "Dauerhafte Dauerlizenz ohne jährliche Gebühren",
        "Voll kompatibel mit Windows 10 und Windows 11",
        "Lebenslange Umtauschgarantie"
      ],
      "instructions": [
        "1. Offizielles Office 2024 Setup von Microsoft herunterladen",
        "2. Word öffnen und Produktschlüssel eingeben",
        "3. Online-Aktivierung abschließen"
      ],
      "tags": [
        "Microsoft",
        "Office 2024",
    ...
    "es": {
      ...
      "features": [
        "Incluye Word, Excel, PowerPoint, Outlook, Access 2024",
        "Activación permanente sin cuotas recurrentes",
        "Compatible con Windows 10 y Windows 11",
        "Garantía de por vida"
      ],
      "instructions": [
        "1. Descarga el instalador oficial de Office 2024",
        "2. Abre Word e introduce tu clave de producto",
        "3. Completa la activación online al instante"
      ],
      "tags": [
        "Microsoft",
        "Office 2024",
  ...
  "prod-idm-lifetime": {
    "vi": {
      ...
      "features": [
        "Tăng tốc tải dữ liệu gấp 500%",
        "Bắt link YouTube, video, MP3 tự động 1-click",
        "Hỗ trợ cập nhật lên phiên bản mới trọn đời",
        "Bảo hành vĩnh viễn 1 đổi 1"
      ],
      "instructions": [
        "1. Tải IDM từ trang chủ internetdownloadmanager.com",
        "2. Vào Registration -> Registration và nhập thông tin + key",
        "3. Thưởng thức tốc độ tải file tối đa"
      ],
      "tags": [
        "IDM",
        "Download",
    ...
    "en": {
      ...
      "features": [
        "Accelerates download speeds by up to 500%",
        "Automated 1-click video grabber for streaming sites",
        "Lifetime free software version updates",
        "Lifetime replacement warranty guarantee"
      ],
      "instructions": [
        "1. Download IDM from internetdownloadmanager.com",
        "2. Open Registration -> Registration and enter your key",
        "3. Enjoy maximum download speeds"
      ],
      "tags": [
        "IDM",
        "Download",
    ...
    "zh": {
      ...
      "instructions": [
        "1. 从 IDM 官网 internetdownloadmanager.com 下载客户端",
        "2. 打开菜单“注册” -> “注册”，填入姓名及保险库中的序列号",
        "3. 体验极致高速下载"
      ],
      "tags": [
        "IDM",
    ...
    "ja": {
      ...
      "features": [
        "ダウンロード速度を最大 500% 高速化",
        "動画配信サイトのストリームを 1 クリック自動取得",
        "永久無料バージョンアップグレード",
        "永久ライセンス保証付き"
      ],
      "instructions": [
        "1. 公式サイト internetdownloadmanager.com よりダウンロード",
        "2. メニューの「登録」からライセンスキーを入力",
        "3. 最高速のダウンロードを開始"
      ],
      "tags": [
        "IDM",
    ...
    "ko": {
      ...
      "features": [
        "다운로드 속도 최대 500% 다중 스레드 가속",
        "웹 동영상 및 MP3 원클릭 자동 추출",
        "최신 버전 평생 무료 업데이트 지원",
        "평생 정품 1:1 교환 보증"
      ],
      "instructions": [
        "1. IDM 공식 홈페이지에서 프로그램 다운로드",
        "2. 등록 -> 등록 메뉴에서 볼트의 시리얼 키 입력",
        "3. 초고속 파일 다운로드 경험"
      ],
      "tags": [
        "IDM",
    ...
    "ru": {
      ...
      "features": [
        "Ускорение загрузки до 500%",
        "Автоматический захват видео со страниц",
        "Пожизненные бесплатные обновления версии",
        "Пожизненная гарантия"
      ],
      "instructions": [
        "1. Скачайте IDM с internetdownloadmanager.com",
        "2. Откройте Меню -> Регистрация и введите ключ",
        "3. Качайте на максимальной скорости"
      ],
      "tags": [
        "IDM",
        "Загрузка",
    ...
    "fr": {
      ...
      "features": [
        "Accélère les téléchargements jusqu’à 500%",
        "Capture automatique de vidéos en 1 clic",
        "Mises à jour gratuites à vie du logiciel",
        "Garantie à vie"
      ],
      "instructions": [
        "1. Téléchargez IDM sur internetdownloadmanager.com",
        "2. Allez dans Enregistrement -> Enregistrement et entrez la clé",
        "3. Profitez de vitesses maximales"
      ],
      "tags": [
        "IDM",
        "Téléchargement",
    ...
    "de": {
      ...
      "features": [
        "Bis zu 500% schnellere Downloads",
        "Automatischer 1-Klick Video-Grabber für Webseiten",
        "Lebenslang kostenlose Versions-Updates",
        "Lebenslange Umtauschgarantie"
      ],
      "instructions": [
        "1. IDM von internetdownloadmanager.com herunterladen",
        "2. Registrierung -> Registrieren wählen und Schlüssel eingeben",
        "3. Maximale Download-Raten genießen"
      ],
      "tags": [
        "IDM",
        "Download-Manager",
    ...
    "es": {
      ...
      "features": [
        "Aumenta la velocidad de descarga hasta un 500%",
        "Captura vídeos de la web automáticamente con 1 clic",
        "Actualizaciones gratuitas de versión de por vida",
        "Garantía de por vida"
      ],
      "instructions": [
        "1. Descarga IDM en internetdownloadmanager.com",
        "2. Abre Registro -> Registro e introduce tu clave",
        "3. Disfruta de la máxima velocidad de descarga"
      ],
      "tags": [
        "IDM",
        "Descargas",
  ...
  "prod-topup-lienquan-1050": {
    "vi": {
      ...
      "features": [
        "Cộng trực tiếp 1.050 Quân Huy vào tài khoản",
        "Không cần mật khẩu, chỉ cần nhập OpenID",
        "Tính đầy đủ các mốc sự kiện & quà nạp đầu",
        "Bảo hiểm sạch 100% qua Escrow"
      ],
      "instructions": [
        "1. Nhập OpenID tài khoản Liên Quân của bạn",
        "2. Xác nhận thanh toán qua ví Cyber Balance",
        "3. Mở game kiểm tra Quân Huy sau 3 giây"
      ],
      "tags": [
        "Liên Quân Mobile",
        "Quân Huy",
    ...
    "en": {
      ...
      "features": [
        "Direct 1,050 Vouchers credited to in-game balance",
        "No password required, OpenID only",
        "Qualifies for first-recharge bonus & event milestones",
        "100% clean currency escrow guarantee"
      ],
      "instructions": [
        "1. Enter your Arena of Valor OpenID",
        "2. Confirm payment using your Cyber Wallet",
        "3. Open the game to verify your Vouchers in 3 seconds"
      ],
      "tags": [
        "Arena of Valor",
        "Vouchers",
    ...
    "ja": {
      ...
      "features": [
        "1,050 バウチャーをゲーム内残高へ即座に加算",
        "パスワード不要、OpenID のみで安全取引",
        "初回チャージ特典・イベント進行度に完全反映",
        "100% クリーン通貨保証"
      ],
      "instructions": [
        "1. ご自身の OpenID を入力",
    ...
    "ko": {
      ...
      "features": [
        "게임 계정에 1,050 바우처 즉시 충전",
        "비밀번호 불필요, OpenID만으로 안전 처리",
        "첫 충전 보너스 및 시즌 이벤트 마일리지 적립",
        "정품 재화 에스크로 100% 보증"
      ],
      "instructions": [
        "1. 게임 내 OpenID 입력",
        "2. 사이버 지갑으로 결제 확인",
        "3. 3초 후 게임 접속하여 바우처 수령 확인"
      ],
      "tags": [
        "아레나오브발러",
        "바우처",
    ...
    "ru": {
      ...
      "features": [
        "1 050 ваучеров поступают на баланс",
        "Без пароля, только OpenID",
        "Засчитывается в бонусы и события",
        "100% гарантия чистой валюты"
      ],
      "instructions": [
        "1. Введите ваш OpenID в игре",
        "2. Подтвердите оплату с кошелька",
        "3. Откройте игру и проверьте баланс"
      ],
      "tags": [
        "Arena of Valor",
        "Ваучеры",
    ...
    "fr": {
      ...
      "features": [
        "1 050 Vouchers crédités instantanément",
        "Aucun mot de passe requis, OpenID uniquement",
        "Compte pour les bonus et récompenses d’événements",
        "Garantie de devise légale à 100%"
      ],
      "instructions": [
        "1. Indiquez votre OpenID Arena of Valor",
        "2. Confirmez le règlement",
        "3. Lancez le jeu pour vérifier vos Vouchers"
      ],
      "tags": [
        "Arena of Valor",
        "Vouchers",
    ...
    "de": {
      ...
      "features": [
        "1.050 Gutscheine werden direkt im Spiel gutgeschrieben",
        "Kein Passwort nötig, nur OpenID",
        "Qualifiziert für Erstauflade-Bonus & Event-Meilensteine",
        "100% Treuhand-Sicherheit"
      ],
      "instructions": [
        "1. Arena of Valor OpenID eingeben",
        "2. Bezahlung über Wallet bestätigen",
        "3. Spiel nach 3 Sekunden öffnen und Guthaben prüfen"
      ],
      "tags": [
        "Arena of Valor",
        "Gutscheine",
    ...
    "es": {
      ...
      "features": [
        "Acreditación directa de 1.050 vales en el juego",
        "Sin contraseñas, solo necesitas tu OpenID",
        "Válido para eventos de recarga y pases",
        "Garantía 100% legal con Escrow"
      ],
      "instructions": [
        "1. Introduce tu OpenID de Arena of Valor",
        "2. Confirma el pago desde tu saldo",
        "3. Abre el juego y verifica tus vales en 3 segundos"
      ],
      "tags": [
        "Arena of Valor",
        "Vales",
  ...
  "prod-topup-freefire-2180": {
    "vi": {
      ...
      "features": [
        "Cộng trực tiếp 2.180 Kim Cương vào tài khoản",
        "Chỉ cần Player ID, an toàn tuyệt đối",
        "Hưởng đầy đủ quà nạp và sự kiện Garena",
        "Bảo hiểm sạch 100% qua Escrow"
      ],
      "instructions": [
        "1. Nhập Player ID Free Fire",
        "2. Xác nhận thanh toán",
        "3. Nhận Kim Cương trong game sau 3 giây"
      ],
      "tags": [
        "Free Fire",
        "Kim Cương",
    ...
    "en": {
      ...
      "features": [
        "Direct 2,180 Diamonds credited to in-game balance",
        "Only Player ID required, 100% account security",
        "Full eligibility for active Garena events and bonuses",
        "100% clean currency escrow guarantee"
      ],
      "instructions": [
        "1. Enter your Free Fire Player ID",
        "2. Confirm payment using your Cyber Wallet",
        "3. Open the game to verify your Diamonds in 3 seconds"
      ],
      "tags": [
        "Free Fire",
        "Diamonds",
    ...
    "zh": {
      ...
      "features": [
        "2,180 钻石即刻入账游戏账户",
        "只需输入 Player ID，保障账号隐私安全",
        "完美触发首充双倍返利与精英通行证",
        "全额保单质保，官方正规渠道直充"
      ],
      "instructions": [
        "1. 输入您的 Free Fire 玩家 ID",
        "2. 使用账户余额确认支付",
        "3. 3秒后在游戏中确认钻石"
      ],
      "tags": [
    ...
    "ko": {
      ...
      "features": [
        "게임 계정에 2,180 다이아몬드 즉시 충전",
        "플레이어 ID만으로 안전하게 거래",
        "엘리트 패스 및 첫 충전 보너스 혜택 적용",
        "100% 정품 재화 에스크로 보증"
      ],
      "instructions": [
        "1. 프리 파이어 플레이어 ID 입력",
        "2. 결제 승인",
        "3. 3초 후 인게임 다이아몬드 충전 확인"
      ],
      "tags": [
        "Free Fire",
        "다이아몬드",
    ...
    "ru": {
      ...
      "features": [
        "2 180 алмазов на игровой аккаунт",
        "Только Player ID, без пароля",
        "Поддержка всех событий Garena",
        "100% гарантия"
      ],
      "instructions": [
        "1. Введите ваш Free Fire Player ID",
        "2. Подтвердите оплату",
        "3. Получите алмазы в игре за 3 секунды"
      ],
      "tags": [
        "Free Fire",
        "Алмазы",
    ...
    "fr": {
      ...
      "features": [
        "2 180 Diamants crédités sur le compte",
        "Player ID uniquement, sans mot de passe",
        "Compatible avec le Pass Élite et les bonus",
        "Garantie légale 100%"
      ],
      "instructions": [
        "1. Entrez votre Player ID Free Fire",
        "2. Validez le paiement",
        "3. Lancez le jeu pour profiter de vos Diamants"
      ],
      "tags": [
        "Free Fire",
        "Diamants",
    ...
    "de": {
      ...
      "features": [
        "2.180 Diamanten direkt im Spiel",
        "Nur Spieler-ID erforderlich",
        "Kompatibel mit allen Garena-Aktionen",
        "100% Treuhand-Sicherheit"
      ],
      "instructions": [
        "1. Free Fire Player-ID eingeben",
        "2. Zahlung bestätigen",
        "3. Spiel nach 3 Sekunden starten und Diamanten nutzen"
      ],
      "tags": [
        "Free Fire",
        "Diamanten",
    ...
    "es": {
      ...
      "features": [
        "2.180 diamantes acreditados al instante",
        "Solo necesitas tu Player ID, sin contraseñas",
        "Válido para eventos de Garena y pases élite",
        "Garantía 100% legal con Escrow"
      ],
      "instructions": [
        "1. Introduce tu Player ID de Free Fire",
        "2. Confirma el pago",
        "3. Abre el juego y verifica tus diamantes en 3 segundos"
      ],
      "tags": [
        "Free Fire",
        "Diamantes",
  ...
  "prod-topup-genshin-3280": {
    "vi": {
      ...
      "features": [
        "Cộng trực tiếp 3.280 Đá Sáng Thế vào game",
        "Hưởng nhân đôi (x2 = 6.560 Đá) nếu chưa nạp mốc này",
        "Chỉ cần UID và Server, không cần mật khẩu",
        "Bảo hiểm sạch 100% qua Escrow"
      ],
      "instructions": [
        "1. Nhập UID và chọn Server game của bạn",
        "2. Xác nhận thanh toán qua ví Cyber",
        "3. Nhận Đá Sáng Thế trong game sau 3 giây"
      ],
      "tags": [
        "Genshin Impact",
        "Hoyoverse",
    ...
    "en": {
      ...
      "features": [
        "Direct 3,280 Genesis Crystals credited to your account",
        "Qualifies for 2x First-Time Bonus (6,560 Crystals)",
        "Only UID & Server required, no password needed",
        "100% clean currency escrow guarantee"
      ],
      "instructions": [
        "1. Enter your Genshin Impact UID and select Server",
        "2. Confirm payment using your Cyber Wallet",
        "3. Open the game to verify your Crystals in 3 seconds"
      ],
      "tags": [
        "Genshin Impact",
        "Hoyoverse",
    ...
    "zh": {
      ...
      "features": [
        "3,280 创世结晶即刻入账游戏账户",
        "若未曾充值过该档位，自动触发首充双倍 (6,560 结晶)",
        "仅需提供 UID 与服务器，100% 账号安全",
        "全额保单质保，官方正规白卡充值"
      ],
      "instructions": [
        "1. 输入您的原神 UID 并选择游戏服务器",
        "2. 使用账户余额确认支付",
        "3. 3秒后在游戏中查收创世结晶"
      ],
      "tags": [
    ...
    "ja": {
      ...
      "features": [
        "3,280 創世結晶をゲーム内へ即時加算",
        "未購入時は初回2倍ボーナス (6,560 結晶) 適用",
        "UID とサーバーのみで安心・安全",
        "100% 正規通貨保証"
      ],
      "instructions": [
        "1. 原神 UID を入力しサーバーを選択",
        "2. 決済を確認",
        "3. 3秒後にゲーム内で創世結晶を確認"
      ],
      "tags": [
    ...
    "ko": {
      ...
      "features": [
        "게임 계정에 3,280 창세의 결정 즉시 충전",
        "미충전 시 첫 충전 2배 (6,560개) 자동 적용",
        "UID와 서버만으로 안전하게 처리",
        "100% 정품 재화 에스크로 보증"
      ],
      "instructions": [
    ...
    "ru": {
      ...
      "features": [
        "3 280 Кристаллов Сотворения на аккаунт",
        "Бонус 2x при первом пополнении (6 560 Кристаллов)",
        "Только UID и сервер, без пароля",
        "100% гарантия"
      ],
      "instructions": [
        "1. Введите UID и выберите сервер",
        "2. Подтвердите оплату",
        "3. Получите кристаллы в игре за 3 секунды"
      ],
      "tags": [
        "Genshin Impact",
    ...
    "fr": {
      ...
      "features": [
        "3 280 Cristaux Primaires crédités instantanément",
        "Bonus 2x au premier achat (6 560 Cristaux)",
        "UID et serveur uniquement, sans mot de passe",
        "Garantie légale 100%"
      ],
      "instructions": [
        "1. Entrez votre UID Genshin et choisissez le serveur",
        "2. Validez le paiement",
        "3. Lancez le jeu pour profiter de vos Cristaux"
      ],
      "tags": [
        "Genshin Impact",
        "Cristaux Primaires",
    ...
    "de": {
      ...
      "features": [
        "3.280 Schöpfungskristalle direkt auf Ihr Konto",
        "Qualifiziert für 2x Erstauflade-Bonus (6.560 Kristalle)",
        "Nur UID & Server nötig, kein Passwort",
        "100% Treuhand-Sicherheit"
      ],
      "instructions": [
        "1. Genshin Impact UID eingeben und Server wählen",
        "2. Bezahlung über Wallet bestätigen",
        "3. Spiel nach 3 Sekunden öffnen und Kristalle nutzen"
      ],
      "tags": [
        "Genshin Impact",
        "Schöpfungskristalle",
    ...
    "es": {
      ...
      "features": [
        "3.280 Cristales Génesis acreditados al instante",
        "Bono x2 en la primera recarga (6.560 Cristales)",
        "Solo necesitas tu UID y Servidor, sin contraseñas",
        "Garantía 100% legal con Escrow"
      ],
      "instructions": [
        "1. Introduce tu UID de Genshin Impact y elige el servidor",
        "2. Confirma el pago desde tu saldo",
        "3. Abre el juego y verifica tus cristales en 3 segundos"
      ],
      "tags": [
        "Genshin Impact",
        "Cristales Génesis",
